...
export const homeObjOne = {
    ...
    description:
      '',
    descriptionTwo: 'I enjoy building dynamic, creative products from start to finish. I focus on developing intuitive experiences that constantly grow and imporve based on user metrics.',
    descriptionThree: <>
